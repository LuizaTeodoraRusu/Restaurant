...
namespace Medii.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ReservationsController(MediiContext context)
        {
            _context = context;
        }
        ...
        {
            var mediiContext = _context.Reservation.Include(r => r.Location).Include(r => r.Menu);
            return View(await mediiContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MediiContext.Reservation'  is null.");
            }
            var reservation = await _context.Reservation.FindAsync(id);
            if (reservation != null)
            {
